...
/**
 * Similarity features for optimized batch comparison
 */
...
/**
 * Extract similarity features from content once for efficient comparison
 */
...
/**
 * Get n-grams (3-character sequences) from a string
 */
...
export function calculateSimilarityWithFeatures(f1: SimilarityFeatures, f2: SimilarityFeatures): number {
  ...
  const ngram = jaccardSimilarity(f1.ngrams, f2.ngrams);
...
/**
 * Optimized check for similar content using features
 */
