...
/**
 * Features used for similarity calculation to avoid redundant computations
 */
 ...
 */
export function calculateSetSimilarity(set1: Set<string>, set2: Set<string>): number {
...
/**
 * Calculate similarity between two sets of pre-extracted features
 */
