...
describe("isPrivateUrl", () => {
  it("should return true for private IPv4 addresses and loopback", async () => {
  ...
  it("should return true for IPv6 loopback and private addresses", async () => {
  ...
  it("should return false for valid public URLs", async () => {
    ...
    expect(await isPrivateUrl("https://api.github.com/events")).toBe(false);
  });

  it("should return true for invalid URLs or unsupported protocols", async () => {
