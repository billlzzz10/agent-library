...
export async function POST(request: Request) {
  try {
    ...
    // First, extract features for the new content to avoid redundant work in the loop
    ...
    if (newContentFeatures.normalized.length > 50) {
      ...
      // Performance: By pre-extracting features for the new content, we avoid 1000x redundant
      // normalization and tokenization calls.
