...
import { normalizeContent, extractFeatures, isSimilarContentWithFeatures } from "@/lib/similarity";
...
export async function POST(request: Request) {
  try {
    ...
    // Extract features once for the new content to optimize bulk comparison
    ...
    if (newPromptFeatures.normalized.length > 50) {
      ...
      // Find similar content using optimized bulk similarity algorithm
