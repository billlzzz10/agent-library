...
export async function POST(request: Request) {
  try {
    ...
    // Pre-extract features for the new prompt content once before batch comparison
    ...
    if (newContentFeatures.normalized.length > 50) {
      ...
      // Find similar content using pre-extracted features to avoid redundant regex & set parsing inside loop
