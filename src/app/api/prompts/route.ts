...
export async function POST(request: Request) {
  try {
    ...
    // First, extract features for the new content once
    ...
    if (newContentFeatures.normalized.length > 50) {
      ...
      // Optimization: extract features for each candidate prompt and compare using pre-extracted features for the new content
      // This avoids re-normalizing and re-tokenizing the new content 1000 times
