...
function EmbedContent() {
    ...
    if (context.startsWith("@")) {
      ...
      icon = (
        <svg className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
          <path
            fillRule="evenodd"
            d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V7.414A2 2 0 0017.414 6L14 2.586A2 2 0 0012.586 2H4zm2 4a1 1 0 011-1h4a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7zm-1 5a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z"
            clipRule="evenodd"
          />
        </svg>
      );
    ...
    return (
      <div key={node.path}>
        <button
          ...
          className="flex w-full items-center gap-1.5 rounded py-0.5 text-left text-[10px] transition-colors"
          style={{
        ...
        >
          {node.isFolder ? (
            ...
            <svg className="h-3 w-3 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
              <path
                fillRule="evenodd"
                d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V7.414A2 2 0 0017.414 6L14 2.586A2 2 0 0012.586 2H4z"
                clipRule="evenodd"
              />
            </svg>
          )}
  ...
  return (
    <div
      className={cn("flex h-screen", isDark ? "dark" : "")}
      style={
        {
    ...
    >
      ...
      {fileTree.length > 0 && (
        <div
          className="w-40 flex-shrink-0 overflow-y-auto border-r sm:w-44"
          style={{
            backgroundColor: isDark ? "rgba(38,38,38,0.5)" : "#ffffff",
            borderColor: isDark ? "#404040" : "#e2e8f0",
          }}
        >
          <div className="border-b p-2" style={{ borderColor: isDark ? "#404040" : "#e2e8f0" }}>
            <h3
          ...
          <div className="py-1">{fileTree.map((node) => renderTreeNode(node))}</div>
        </div>
      )}

      {/* Main Content */}
      <div
        className="relative flex h-full flex-1 flex-col overflow-hidden p-2 sm:p-4"
      ...
      >
        ...
        {config.showDiff && config.diffFilename && (
          <div
            className={cn(
              "bg-muted border-border mb-2 flex-shrink-0 rounded-lg border p-2 transition-all",
              diffCollapsed && "py-1"
            )}
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <div className="flex overflow-hidden rounded-md">
                  <button
                    className={cn(
                      "flex items-center gap-0.5 bg-green-500 px-2 py-0.5 text-[10px] font-medium text-white transition-colors hover:bg-green-600",
                  ...
                  <button
                    className={cn(
                      "flex items-center gap-0.5 bg-red-500 px-2 py-0.5 text-[10px] font-medium text-white transition-colors hover:bg-red-600",
                ...
                >
                  <svg
                    className={cn("h-3 w-3 transition-transform", diffCollapsed && "rotate-180")}
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
            ...
            {!diffCollapsed && (
              <div className="mt-1.5 space-y-1">
                {config.diffOldText && (
                  <div
                    className="max-h-20 overflow-y-auto rounded p-2 font-mono text-[10px] whitespace-pre-wrap"
                    style={{
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          <div
            className="h-full overflow-y-auto rounded-lg p-3 sm:p-4"
            style={{
          ...
          >
            {config.prompt ? (
              ...
              >
                {renderHighlightedPrompt(config.prompt)}
              </p>
            ) : (
        ...
        <div className="mt-2 flex flex-shrink-0 items-center justify-between">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {(config.thinking ||
              ...
              config.fast ||
              config.max) && (
              <span style={{ color: isDark ? "#a3a3a3" : "#64748b" }} className="text-[10px]">
                •
              </span>
            )}
            {config.thinking && (
